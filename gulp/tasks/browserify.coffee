...
gulp.task 'browserify', ['clean'], ->
  bundler = browserify({
    ...
    .require './bower_components/jquery/dist/jquery', { expose: 'jquery' }
    .require '../node_modules/jquery-ui/slider', { expose: 'jquery.ui.slider' }
    .require '../node_modules/jquery-ui/draggable', { expose: 'jquery.ui.draggable' }
    .require './bower_components/react/react-with-addons', { expose: 'react' }
    .require '../node_modules/react-mixin-manager/react-mixin-manager', { expose: 'react-mixin-manager' }
    ...
    .require './scripts/resources/momentjs/ru', { expose: 'momentjsRU' }
