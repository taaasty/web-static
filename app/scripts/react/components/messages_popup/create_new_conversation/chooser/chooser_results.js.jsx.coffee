...
window.MessagesPopup_ChooserResults = React.createClass
  ...
  componentWillUnmount: ->
    console.log 'RESULTS WILL UNMOUNTED'
  ...
  render: ->
    switch @state.currentState
      ...
      when LOADED_STATE
        content = `<div className="messages__chooser-result">
                     <div className="messages__person" data-id="1">
                       <div className="messages__person-avatar">
                         <span className="avatar avatar--fifth">
                           <span className="avatar__text">A</span>
                         </span>
                       </div>
                       <div className="messages__person-name">azamiryu</div>
                     </div>
                   </div>`
      when EMPTY_STATE
...
# <div class="messages__chooser-results js-messages-chooser-results">
#   <div class="messages__chooser-result state--active">
...
#     </div>
#   </div>
#   <div class="messages__chooser-result">
