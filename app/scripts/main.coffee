...
require './react/components/persons_popup/panels/following_relationship'
require './react/components/persons_popup/panels/followings_panel'
require './react/components/persons_popup/panels/follower_relationship'
require './react/components/persons_popup/panels/followers_panel'
require './react/components/persons_popup/panels/guess_relationship'
require './react/components/persons_popup/panels/guesses_panel'
require './react/components/persons_popup/panels/ignored_relationship'
