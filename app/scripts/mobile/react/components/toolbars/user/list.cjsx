...
NEW_ENTRY_ITEM     = -> i18n.t 'toolbar_new_entry_item'
MY_DIARY_ITEM      = -> i18n.t 'toolbar_my_diary_item'
PROFILE_ITEM       = -> i18n.t 'toolbar_profile_item'
FAVORITES_ITEM     = -> i18n.t 'toolbar_favorites_item'
NEW_ANONYMOUS_ITEM = -> i18n.t 'toolbar_new_anonymous_item'
PRIVATES_ITEM      = -> i18n.t 'toolbar_privates_item'
MESSAGES_ITEM      = -> i18n.t 'toolbar_messages_item'
FRIENDS_ITEM       = -> i18n.t 'toolbar_friends_item'
DESIGN_ITEM        = -> i18n.t 'toolbar_design_item'
SETTINGS_ITEM      = -> i18n.t 'toolbar_settings_item'
LOGOUT_ITEM        = -> i18n.t 'toolbar_logout_item'
