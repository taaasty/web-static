/*global ReactGrammarMixin, messagingService, TastyEvents, MessageActions */
import React, { createClass, findDOMNode, PropTypes } from 'react';
import MessagesStore from '../../../../stores/MessagesStore';
import MessagesPopupThreadMessageListItem from './MessagesPopupThreadMessageListItem';
...
const MessagesPopupThreadMessageListItemManager = createClass({
  propTypes: {
  ...
  getInitialState() {
    return Object.assign({}, this.stateFromProps(this.props), { selected: false });
  },
  ...
  render() {
    ...
    return (
      <MessagesPopupThreadMessageListItem
...
export default MessagesPopupThreadMessageListItemManager;
