...
function UserToolbarPrimaryList(props) {
  const { currentUser: { slug, tlog_url, userpic }, onDesignSettingsClick,
          onFriendsClick, onNotificationsClick, onMessagesClick, unreadAnonymousCount,
          unreadBestCount, unreadConversationsCount, unreadFriendsCount, unreadLiveCount,
          unreadLiveFlowCount, unreadNotificationsCount } = props;
