...
(function($){
   ...
   */
  Tasty.createAvatar = function(username, userpic){
    if (typeof $.render.avatarTmpl == "undefined") {
      $.templates("avatarTmpl", "#tmpl-avatar");
    }

    var avatarData = this.prepareAvatar(username, userpic);

    return $.render.avatarTmpl({
...
(function($){
  var defaults = {
    ...
    dialogsUrl: "api/messages/dialogs.json",
    ...
    _renderDialogs: function(dialogs){
      ...
      $.each(dialogs, function(){
        var dialogHtml = templates.dialog.render({
          ...
          avatar: Tasty.createAvatar(this.user.name, this.user.pic),
